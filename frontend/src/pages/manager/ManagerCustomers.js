...
export default function ManagerCustomers() {
  ...
  return (
    <div className="customers-body">
      <header className="customers-topbar" style={{ position: "static", borderBottom: "none", background: "transparent", padding: "0 0 16px 0", minHeight: "auto" }}>
        <div>
          <span style={{ fontSize: "11px", fontWeight: "900", color: "var(--manager-primary)", letterSpacing: "0.12em", textTransform: "uppercase" }}>Chăm sóc khách hàng</span>
          <h2 style={{ fontSize: "30px", fontWeight: "900", color: "var(--manager-ink)", margin: "4px 0 0" }}>Khách hàng</h2>
        </div>
