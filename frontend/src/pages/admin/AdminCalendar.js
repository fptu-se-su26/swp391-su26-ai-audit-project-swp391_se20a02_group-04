            ...
            <main className="main-content">
                ...
                <header className="header">
                    <div className="header-left">
                        <h2>MOTOCORE</h2>
                        <span className="breadcrumb">Garage Admin</span>
                    </div>
                ...
                <div className="calendar-body">
                    ...
                    <div className="filter-bar">
                        <div className="filter-buttons">
                            <button className="btn-filter-icon"><Filter size={16} /> BỘ LỌC:</button>
                            ...
                            {appointments.map((item, index) => (
                                <div className="table-row" key={index}>
                                    ...
                                    <div className="col-time">
                                        <p className="time-date flex items-center"><Calendar size={14} className="mr-2" /> {item.time}</p>
                                        <p className="time-hour flex items-center"><Clock size={14} className="mr-2" /> {item.hour}</p>
                                    </div>
                                    ...
                                    <div className="col-action">
                                        <button className="detail-link">Chi tiết <ChevronRight size={16} /></button>
                                    </div>
                                </div>
                            ))}
                        </div>
